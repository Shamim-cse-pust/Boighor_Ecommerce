...
use App\Http\Livewire\Admin\AdminTokenComponent;
use App\Http\Livewire\Admin\AdminAddTokenComponent;
use App\Http\Livewire\Admin\AdminEditTokenComponent;
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/admin/token', AdminTokenComponent::class)->name('admin.token');
    Route::get('/admin/token/add', AdminAddTokenComponent::class)->name('admin.addtoken');
    Route::get('/admin/token/edit/{token_id}', AdminEditTokenComponent::class)->name('admin.edittoken');
});